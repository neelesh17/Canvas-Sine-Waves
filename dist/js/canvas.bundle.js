...
strokeFolder.open();
var rectFolder = gui.addFolder('rectColor');
...
function animate() {
  ...
  c.fillStyle = "rgba(".concat(rectColor.r, ", ").concat(rectColor.g, ", ").concat(rectColor.b, ", ").concat(rectColor.a, ")");
  ...
  c.strokeStyle = "hsl(".concat(strokeColor.h, ", ").concat(strokeColor.s, "%, ").concat(strokeColor.l, "%)");
  c.stroke();
